...
--[[ n( "<leader>vwm", function() require("vim-with-me").StartVimWithMe() end) ]]
--[[ n( "<leader>svwm", function() require("vim-with-me").StopVimWithMe() end) ]]
...
n( "<leader><space>" , ":set paste<CR>m`o<Esc>``:set nopaste<CR>")
n( "<leader><leader><space>" , ":set paste<CR>m`O<Esc>``:set nopaste<CR>")
